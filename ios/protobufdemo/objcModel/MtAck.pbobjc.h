 ...
 **/
@interface MtAckRoot : GPBRootObject
@end

#pragma mark - MtAck

typedef GPB_ENUM(MtAck_FieldNumber) {
  MtAck_FieldNumber_DateTime = 1,
  MtAck_FieldNumber_InstanceIdMsb = 2,
  MtAck_FieldNumber_InstanceIdLsb = 3,
  MtAck_FieldNumber_MsgId = 4,
};

@interface MtAck : GPBMessage
